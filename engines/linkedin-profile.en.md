...
**About 8 thousand words, so roughly 10 thousand tokens.** A host whose window is smaller than that will truncate this file rather than refuse it, and say nothing.
